import {
  ViewportRuler
} from "./chunk-4C5G4NU4.js";
import {
  CdkPortal,
  CdkPortalOutlet,
  PortalModule,
  TemplatePortal
} from "./chunk-AJELUS5V.js";
import "./chunk-B5J477HA.js";
import {
  A11yModule,
  CdkMonitorFocus,
  CdkObserveContent,
...
function MatTabGroup_For_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener("click", function MatTabGroup_For_3_Template_div_click_0_listener() {
      ...
      return ɵɵresetView(ctx_r13._handleClick(tab_r4, _r0, i_r5));
    })("cdkFocusChange", function MatTabGroup_For_3_Template_div_cdkFocusChange_0_listener($event) {
      const restoredCtx = ɵɵrestoreView(_r14);
      const i_r5 = restoredCtx.$index;
      const ctx_r15 = ɵɵnextContext();
      return ɵɵresetView(ctx_r15._tabFocusChanged($event, i_r5));
    });
  ...
  if (rf & 2) {
    ...
    ɵɵadvance(3);
    ɵɵproperty("matRippleTrigger", _r7)("matRippleDisabled", tab_r4.disabled || ctx_r1.disableRipple);
    ɵɵadvance(3);
...
function MatTabGroup_For_7_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵclassProp("mat-mdc-tab-body-active", ctx_r3.selectedIndex === i_r17);
    ɵɵproperty("id", ctx_r3._getTabContentId(i_r17))("ngClass", tab_r16.bodyClass)("content", tab_r16.content)("position", tab_r16.position)("origin", tab_r16.origin)("animationDuration", ctx_r3.animationDuration)("preserveContent", ctx_r3.preserveContent);
    ɵɵattribute("tabindex", ctx_r3.contentTabIndex != null && ctx_r3.selectedIndex === i_r17 ? ctx_r3.contentTabIndex : null)("aria-labelledby", ctx_r3._getTabLabelId(i_r17))("aria-hidden", ctx_r3.selectedIndex !== i_r17);
  }
}
...
_MatTabGroup.ɵcmp = ɵɵdefineComponent({
  ...
  template: function MatTabGroup_Template(rf, ctx) {
    ...
    if (rf & 2) {
      ...
      ɵɵrepeater(2, ctx._tabs);
      ɵɵadvance(4);
      ɵɵclassProp("_mat-animation-noopable", ctx._animationMode === "NoopAnimations");
      ɵɵrepeater(6, ctx._tabs);
    }
  },
